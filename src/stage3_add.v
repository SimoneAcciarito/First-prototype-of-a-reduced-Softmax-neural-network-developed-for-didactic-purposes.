// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\r24b_pseudosoftmax_in10_8bit\stage3_add.v
...
// 
// Module: stage3_add
// Source Path: r24b_pseudosoftmax_in10_8bit/PseudoSM_ASIC/FLP_adder/stage3_add
// Hierarchy Level: 2
// Model version: 9.0
// 
// -------------------------------------------------------------
...
module stage3_add
  ...
  input   clk;
  input   reset;
  input   signed [9:0] exp1;  // sfix10
  input   signed [9:0] exp2;  // sfix10
  input   [7:0] mant1;  // ufix8_En8
  input   [7:0] mant2;  // ufix8_En8
  output  signed [10:0] exp_out;  // sfix11
  ...
  wire Delay11_out1;
  reg signed [9:0] Delay12_reg [0:3];  // sfix10 [4]
  reg signed [9:0] Delay12_reg_next [0:3];  // sfix10 [4]
  reg signed [9:0] Delay12_out1;  // sfix10
  reg signed [9:0] Delay13_reg [0:3];  // sfix10 [4]
  reg signed [9:0] Delay13_reg_next [0:3];  // sfix10 [4]
  reg signed [9:0] Delay13_out1;  // sfix10
  wire signed [9:0] Multiport_Switch_out1;  // sfix10
  ...
  reg [8:0] Delay7_reg [0:1];  // ufix9 [2]
  wire [8:0] Delay7_reg_next [0:1];  // ufix9_En8 [2]
  wire [8:0] Delay7_out1;  // ufix9_En8
  wire [8:0] Multiport_Switch2_out1;  // ufix9_En8
  wire signed [10:0] Add1_1;  // sfix11
  wire signed [10:0] Add1_2;  // sfix11
  wire signed [10:0] Add1_out1;  // sfix11
  reg signed [10:0] Delay_out1;  // sfix11
  wire signed [11:0] Abs_y;  // sfix12
  wire signed [11:0] Abs_1;  // sfix12
  ...
  wire signed [10:0] Add_1;  // sfix11
  wire signed [10:0] Add_2;  // sfix11
    ...
    begin : Delay12_process
      if (reset == 1'b1) begin
        for(Delay12_t_1 = 32'sd0; Delay12_t_1 <= 32'sd3; Delay12_t_1 = Delay12_t_1 + 32'sd1) begin
          Delay12_reg[Delay12_t_1] <= 10'sb0000000000;
        end
      end
      else begin
    ...
    begin : Delay13_process
      if (reset == 1'b1) begin
        for(Delay13_t_1 = 32'sd0; Delay13_t_1 <= 32'sd3; Delay13_t_1 = Delay13_t_1 + 32'sd1) begin
          Delay13_reg[Delay13_t_1] <= 10'sb0000000000;
        end
      end
      else begin
  ...
  assign Multiport_Switch3_out1 = (Delay5_out1 == 1'b0 ? Delay8_out1 :
              Delay9_out1);
  ...
  assign Delay6_reg_next[0] = Data_Type_Conversion1_out1;
    ...
    begin : Delay7_process
      if (reset == 1'b1) begin
        for(Delay7_t_1 = 32'sd0; Delay7_t_1 <= 32'sd1; Delay7_t_1 = Delay7_t_1 + 32'sd1) begin
          Delay7_reg[Delay7_t_1] <= 9'b000000000;
        end
      end
      else begin
  ...
  assign Delay7_reg_next[0] = Data_Type_Conversion2_out1;
  assign Delay7_reg_next[1] = Delay7_reg[0];

  assign Multiport_Switch2_out1 = (Delay4_out1 == 1'b0 ? Delay6_out1 :
              Delay7_out1);

  assign Add1_1 = {exp1[9], exp1};
  assign Add1_2 = {exp2[9], exp2};
  assign Add1_out1 = Add1_1 - Add1_2;

  always @(posedge clk or posedge reset)
    begin : Delay_process
      if (reset == 1'b1) begin
        Delay_out1 <= 11'sb00000000000;
      end
      else begin
  ...
  assign Abs_1 = {Delay_out1[10], Delay_out1};
  assign Abs_y = (Delay_out1 < 11'sb00000000000 ?  - (Abs_1) :
              {Delay_out1[10], Delay_out1});
  assign Abs_out1 = ((Abs_y[11] == 1'b0) && (Abs_y[10:4] != 7'b0000000) ? 4'b1111 :
              (Abs_y[11] == 1'b1 ? 4'b0000 :
              Abs_y[3:0]));
  ...
  assign Add_1 = {Multiport_Switch_out1[9], Multiport_Switch_out1};
  assign Add_2 = {10'b0, Extract_Bits_out1};
